...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Fazenda Microcrédito — Crédito acessível em Moçambique" },
      { name: "description", content: "Instituição de microcrédito licenciada pelo Banco de Moçambique. Soluções de crédito acessíveis para negócios, famílias e indivíduos." },
      { name: "author", content: "Fazenda Microcrédito" },
      { property: "og:title", content: "Fazenda Microcrédito — Crédito acessível em Moçambique" },
      { property: "og:description", content: "Instituição de microcrédito licenciada pelo Banco de Moçambique. Soluções de crédito acessíveis para negócios, famílias e indivíduos." },
  ...
  return (
    <QueryClientProvider client={queryClient}>
      <div className="flex min-h-screen flex-col bg-background pt-4">
        <div className="top-green-bar" aria-hidden="true" />
        <SiteHeader />
